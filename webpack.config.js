...
const basePath = path.resolve(__dirname, 'src', 'wordsapp');
...
const vendorPackages = ['font-awesome-webpack', 'vue-flash-message/dist/vue-flash-message.min.css',
  ...
  'retinajs/dist/retina.min.js', 'autosize/dist/autosize.min.js',
];
...
module.exports = {
  entry: {
    ...
    words: path.join(jsPath, 'words.js'),
    language: path.join(jsPath, 'language.js'),
